...
class __TwigTemplate_f72fa1823a853fb94dd262e774b09aa0 extends Template
{
    private $source;
    private $macros = [];
...
";
   ...
   <turbo-frame id=\"the_frame_id\"> 
        ...
        echo "\" title=\"vers Test\">vers Hello</a> 
        </button> 
    </turbo-frame> 
";
    ...
    {
        return array (  99 => 10,  84 => 6,  71 => 3,  59 => 2,  36 => 1,);
    }
...
{% block body %} 
   <turbo-frame id=\"the_frame_id\"> 
        <h2>Page de Test</h2> 
        <button> 
            <a href=\"{{ path('hello', {'nom':'john','prenom':'doe', 'age':25}) }}\" title=\"vers Test\">vers Hello</a> 
        </button> 
    </turbo-frame> 
{% endblock %} 
